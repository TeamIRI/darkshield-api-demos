...
if __name__ == "__main__":
    ...
    try:
        ...
        process_files = [('cc-sample.png', 'image/png', 'credit-card-masked'),('none-ocra.jpg', 'image/jpg', 'credit-card-masked')]
        i = 0
        for file_name, media_type, masked_folder in process_files:
            ...
            with open(file_name, 'rb') as f:
                ...
                with session.post(url, data=encoder, stream=True,
                    ...
                    parser.register('results', FileTarget(f'{masked_folder}/results{i}.json'))
