...
# Append root directory to PYTHON_PATH so we can import utils.py
...
if __name__ == "__main__":
    ...
    try:
        ...
        process_files = [('hl7-v3-1.xml', 'application/xml', 'xml-masked'),
                         ('hl7-v3-2.xml', 'application/xml', 'xml-masked'),
                         ('hl7-v3-3.xml', 'application/xml', 'xml-masked')
                         ]
