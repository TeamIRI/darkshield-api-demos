...
if __name__ == "__main__":
    ...
    try:
        ...
        process_files = [('buyers.xls', 'application/vnd.ms-excel', 'buyers-masked'),
                         ('Bank Report.xlsx', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', 'bank-report-masked'),
                         ('Bank Statement.doc', 'application/msword', 'statement-doc-masked'),
                         ('Bank Statement.docx', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', 'statement-docx-masked')]
