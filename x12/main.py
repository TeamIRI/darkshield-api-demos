...
if __name__ == "__main__":
    ...
    try:
        ...
        process_files = [('example835.txt', 'text/x12', 'x12-masked'), ('example837.txt', 'text/x12', 'x12-masked'),
                         ('example850.txt', 'text/x12', 'x12-masked'),
                         ('x12_without_lnbreaks.txt', 'text/x12', 'x12-masked')]
